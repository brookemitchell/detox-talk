...
<Appear> <h1> App Release Day 🌊🌩 </h1> </Appear>
...
# Automation 🤖
  <Appear>
	<h2>Automate important checks before submitting</h2>
	<h2>Accept only passing pull requests</h2>
  </Appear>

```notes
- You can watch along
- Then run in headless mode on something like a jenkins or travis server, using using a service like bitrise
- Submit new versions whenever they all pass
